    ...
    if($_SESSION['user']['rol'] === 2){
        ...
        <form id="miForm" class=" w-100 d-flex  align-items-center  flex-column flex-sm-row ">
            <div class="pb-2 d-flex w-100 justify-content-around ">
                ...
                <button id="btn-2" class="shadow-sm btn fs-5 d-flex  justify-content-center  align-items-center p-2 border rounded-4 mt-3 h-100  fw-semibold section__btn--size bg-primary text-white" type="submit">
                    Próximas
                </button>
            </div>
            <div class="pb-2 d-flex w-100 justify-content-around ">

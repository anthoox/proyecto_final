...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (!empty($_POST)) {
        if (isset($_POST['email']) && isset($_POST['password'])) {
            ...
            $datos_sesion = new User_controller();
...
<body class="d-flex flex-column justify-content-between ">
    ...
    <main class="container-xxl d-flex flex-column align-items-center">
        ...
        <form method="post" class="row d-flex flex-column justify-content-center align-items-center fw-semibold w-100">
            ...
            <p class="text-center m-0 mb-3"><a class="fw-bold fs-5 text-success text-decoration-none" href="<?php echo constant('URL') ?>/views/login/recuperacion.php">¿Olvidaste la contraseña?</a></p>

            <button type="submit" class="btn btn-primary text-white border p-1 fs-5 col-2">Entrar</button>
            <p class="text-center mt-3"><a class="fw-bold fs-5 text-success text-decoration-none" href="<?php echo constant('URL') ?>index.php">Volver</a></p>

...
if($_SESSION['user']){
    if($_SESSION['user']['rol'] === 2){
        ...
        <section id="miForm" class="d-flex align-items-center justify-content-between">
            ...
            <button id="btn-2" class=" shadow-sm  btn  bg-primary text-white fs-5 d-flex justify-content-center align-items-center p-1 border rounded-4 mt-3 h-100  fw-semibold section__btn--size" type="submit">
                Próximas
            </button>

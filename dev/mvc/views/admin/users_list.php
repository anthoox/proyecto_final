...
//máximo de páginas
 ...
 echo
 '<h2 class="w-100 mt-3 text-success title title__h2 fs-2 fw-bolder ">
 Usuarios:
 </h2>';
 echo
 '<div class="w-100 div__table--scroll border border-2 rounded-4">
 ...
 <ul class="d-block list-group list-group-flush pt-1">';
    if ($page > 1){
        echo'

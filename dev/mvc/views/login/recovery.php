...
<body class="d-flex flex-column justify-content-between ">
    ...
    <header class="d-none d-md-flex justify-content-between container-fluid d-flex w-100 border-bottom">
            <div class="row w-50">
                <a href="../../index.php"><img class="col-1 p-0 m-0 header__logo" src="http://localhost/proyecto/dev/mvc/resources/img/logo_mini.svg" alt="logo en miniatura"></a>
            </div>
    ...
    <main class="container-xxl d-flex flex-column align-items-center">
        ...
        <form class="row d-flex flex-column justify-content-center align-items-center fw-semibold form w-100">
            ...
            <p class="text-center m-0 mt-3"><a class="fw-bold fs-5 text-success text-decoration-none" href="./login.php">Volver</a></p>
        </form>
    </main>
    <?php

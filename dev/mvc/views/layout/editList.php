<section class="w-100 z-3 fixed-bottom modals  section__editList">   
    ...
    <h3 class="text-center">Editar lista</h3>
        ...
        <button id="btn-rename-list" class="btn bg-secondary text-white fs-5 d-flex justify-content-center align-items-center p-1 border rounded-4 fw-semibold btnSave" type="submit">
            Guardar
        </button>

    ...
    if($lists_items){
        for($i = 0; $i < sizeof($lists_items); $i++){
            ...
            <span class="fw-semibold ms-1 mb-2 m-0 p-0 fs-6">' . $item_price . '</span>
                    ...
                    <p class="p-0 m-0 fs-4 fw-semibold " id="textToStrike"><span class="fs-4 fw-semibold">' .$name_list['list_name']."</span><span class='fs-4 fw-bold text-secondary'> / </span>". $lists_items[$i]['item_name'] . '</p>
                    </div>
